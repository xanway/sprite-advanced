...
>[ void alert(jsonData,callFunction)  弹出提示框 ](#ff_0)
> 
> [void confirm(jsonData,callFunction)  弹出提示选择框 ](#ff_1)
>
>[ void toast(jsonData)   弹出Toast提示  ](#ff_2)
>
> [void actionSheet(jsonData,callFunction) 弹出底部菜单选择 ](#ff_3)
> 
>[void selectDate(jsonData,callFunction)  弹出系统日期选择 ](#ff_4)
> 
> [void selectTime(jsonData,callFunction)   弹出系统时间选择 ](#ff_5)
>
>[ void showImages(jsonData)   显示图片集  ](#ff_6)
>
> [void selectFile(jsonData,callBackFun)    通过js实现文件选择器调用 ](#ff_7)
>
>[ void selectVideo(jsonData,callBackFun)   选择设备中单个视频 ](#ff_8)
> 
> [void selectImage(jsonData,callBackFun)  选择设备中单张图片 ](#ff_9)
>
>[ void selectImages(jsonData,callBackFun)  选择设备中多张图片  ](#ff_10)



<span id="ff_0">**void alert(jsonData,callFunction)**</span>  
...
<span id="ff_1">**void confirm(jsonData,callFunction)**</span>  
...
<span id="ff_2">**void toast(jsonData)**</span>  
...
<span id="ff_3">**void actionSheet(jsonData,callFunction)**</span>  
...
<span id="ff_4">**void selectDate(jsonData,callFunction)**</span>  
...
<span id="ff_5">**void selectTime(jsonData,callFunction)**</span>  
...
<span id="ff_6">**void showImages(jsonData)**</span>  
...
<span id="ff_7">**void selectFile(jsonData,callBackFun)**</span>  
...
<span id="ff_8">**void selectVideo(jsonData,callBackFun)**</span>  
...
<span id="ff_9">**void selectImage(jsonData,callBackFun)**</span>  
